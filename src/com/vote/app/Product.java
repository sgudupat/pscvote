...
public class Product {
	...
	// Variables that hold the information for sending to Anchor and Client
	// detail page
	...
	public Product(String anchorName, String clientName, String campaignId,
			Date endDate, String status, Date creationDate, String websiteURL,
			String clientInfo) {
		super();
	...
	public String getCampaignStatusDescription() {
		if (new Date().after(campaignEndDate)) {
			...
			campaignStatusDescription = "Campaign expires in "
					+ calculateTime();
		}
	...
	public String toString() {
		return "Product{" + "anchorName='" + anchorName + '\''
				+ ", clientName='" + clientName + '\'' + ", campaignId='"
				+ campaignId + '\'' + ", campaignStatusDescription='"
				+ campaignStatusDescription + '\'' + ", campaignEndDate="
				+ campaignEndDate + ", anchorCreationDate="
				+ anchorCreationDate + ", clientWebsiteAddress='"
				+ clientWebsiteAddress + '\'' + ", clientInfo='" + clientInfo
				+ '\'' + '}';
	}
}